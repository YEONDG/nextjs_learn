...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://ydg:Q0qN4QQ2LKMQamOl@cluster0.9au98.mongodb.net/meetup?retryWrites=true&w=majority');
  const db = client.db();
